game:GetService("StarterGui"):SetCore("SendNotification",{	  Title = "RainbowTool", 	  Text = "Script will be loadded in 5 Seconds", 	  Button1 = "OK!"
})
wait(5)
...
ESP:Button("See Monsters", function()
local settings = {
         fillcolor = Color3.fromRGB(0, 255, 255),	         filltransparency = 0.75,
                                                                                                       outlinecolor = Color3.fromRGB(0, 255, 255),	         outlinetransparency = 0,
}
...
ESP:Button("See All People", function()
...
local GG = library:Tab("Game")

GG:Button("Light", function()
...
GG:Button("Get All Items", function()
...
local MM = library:Tab("Movement")

MM:Textbox("Speed", function(nigga)
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = nigga
end)


MM:Textbox("Teleport", function(arg)
    pcall(function()
...
MM:Button("Masturbation FE", function()
...
up.Name = "up"
up.Parent = Frame
up.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
...
down.Name = "down"
down.Parent = Frame
down.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
...
onof.Name = "onof"
onof.Parent = Frame
onof.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
...
TextLabel.Text = "SupremeDoritos's Fly"
...
plus.Name = "plus"
plus.Parent = Frame
plus.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
...
speed.Name = "speed"
speed.Parent = Frame
speed.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
...
mine.Name = "mine"
mine.Parent = Frame
mine.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
